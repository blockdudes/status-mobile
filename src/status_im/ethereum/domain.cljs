...
(defn address
  ...
  (if (ens/is-valid-eth-name? domain-name) (ens/address chain-id domain-name cb) (uns/address chain-id domain-name cb))
)

(defn owner
  [chain-id domain-name cb]
  {:pre [(is-valid-domain-name? domain-name)]}
  (if (ens/is-valid-eth-name? domain-name) (ens/owner chain-id domain-name cb) (uns/owner chain-id domain-name cb))
  )
