(ns quo2.screens.info.page-nav
  (:require [quo.previews.preview :as preview]
            [quo.react-native :as rn]
            [quo.theme :as theme]
            [quo2.components.info.page-nav :as quo2]
...
(def descriptor [{:label "Align middle-component to the left"
                 ...
                 {:label "Left section icon bg color"
                  :key   :left-section-icon-background-color
                  :type  :text}])

(defn cool-preview []
  (let [state (reagent/atom {:right-section-icons [{:background-color colors/primary-40
                                                    :no-color true
                                                    :icon :main-icons/placeholder20}]
                             :horizontal-description? true
                             :one-icon-align-left? true})
        right-icon {:background-color colors/primary-40
                    :no-color true
                    :icon :main-icons/placeholder20}]
    (fn []
